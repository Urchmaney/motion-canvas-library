          ...
          <div className="pt-5 flex flex-col gap-3">
            ...
            <div className="text-gray-500 flex flex-col gap-3">
              <div className="flex justify-between">
                VScode
                <span className="text-xs rounded-md text-black bg-gray-300 flex items-center px-2">32</span>
              </div>
      ...
      <div className="grow min-w-0 pt-10 md:pt-0">
        ...
        <div className="py-5">
          ...
          <div className="w-full">
            { section === "preview" && <MotionCanvasPlayer code={code} /> }
            { section === "code" && <CodeDisplay code={code} /> }
            { section === "usage" && <CodeDisplay code={code} /> }
          </div>
        </div>
